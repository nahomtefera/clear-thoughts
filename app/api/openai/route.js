...
export async function POST(req) {
    ...
    const context = "You're a therapist. Briefly analyze if a thought is good or bad, explain why, and suggest a positive reframe in the prompt's language, wrap the response as html elements, bold 'analysis' and 'positive frame' in a new line: ";
